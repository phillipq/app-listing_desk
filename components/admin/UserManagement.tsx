        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-gray-700 focus:ring-keppel-500 border-gray-300 rounded"
            />
              ...
              <tr key={user.id} className="hover:bg-slate-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-gray-700 focus:ring-keppel-500 border-gray-300 rounded mr-3"
                    />
                    <div>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {user.subscription ? (
                    ...
                    <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-slate-100 text-gray-700">
                      Free
                    </span>
                  )}
                </td>
