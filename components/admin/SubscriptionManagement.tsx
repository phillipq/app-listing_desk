...
export function SubscriptionManagement({ users }: SubscriptionManagementProps) {
  ...
  const handleSubscriptionAction = async (userId: string, action: string, data?: { trialDays?: number }) => {
    setIsLoading(true)
    try {
  ...
  return (
    <div className="bg-white shadow rounded-lg">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-xl font-semibold text-gray-700">Subscription Management</h2>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="text-lg font-medium text-gray-700 mb-4">Free Trial Management</h3>
          ...
          {/* Subscription Actions */}
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="text-lg font-medium text-gray-700 mb-4">Subscription Actions</h3>
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <h3 className="text-lg font-medium text-gray-700 mb-4">Subscription Overview</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-gray-700">Active Subscriptions</div>
            </div>
            ...
            <div className="bg-red-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-gray-700">Canceled Subscriptions</div>
            </div>
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <h3 className="text-lg font-medium text-gray-700 mb-4">Recent Subscriptions</h3>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {usersWithSubscriptions.slice(0, 10).map((user) => (
                  <tr key={user.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-cerulean-800">
                        {user.appId}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
