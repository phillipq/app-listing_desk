...
module.exports = {
  ...
  safelist: [
    // Force include our new 4-color palette classes
    'bg-buff-500',
    'bg-keppel-500', 
    'bg-seasalt-500',
    'bg-gray-500',
    ...
    'border-gray-500',
    'focus:ring-buff-500',
    'focus:ring-keppel-500',
    'focus:ring-seasalt-500',
    'focus:ring-gray-500',
  ],
  presets: [],
  darkMode: "class",
  theme: {
    ...
    boxShadow: {
      ...
      // SoftUI Authentic Shadows
      "soft-sm": "0 3px 5px rgba(0, 0, 0, 0.08)",
      "soft-md": "0 5px 10px rgba(0, 0, 0, 0.1)",
      "soft-lg": "0 10px 20px rgba(0, 0, 0, 0.1)",
      "soft-xl": "0 15px 30px rgba(0, 0, 0, 0.1)",
      "soft-2xl": "0 20px 40px rgba(0, 0, 0, 0.1)",
      
      // SoftUI Colored Shadows
      "soft-cyan": "0 4px 20px 0 rgba(33, 82, 255, 0.14)",
      "soft-lime": "0 4px 20px 0 rgba(130, 214, 22, 0.14)",
      "soft-orange": "0 4px 20px 0 rgba(249, 115, 22, 0.14)",
      "soft-fuchsia": "0 4px 20px 0 rgba(192, 38, 211, 0.14)",
      "soft-red": "0 4px 20px 0 rgba(245, 57, 57, 0.14)",
    },
    willChange: {
      auto: "auto",
