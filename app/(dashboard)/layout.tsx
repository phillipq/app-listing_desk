...
export default async function DashboardLayout({
  ...
  // First try by ID, then by email as fallback
  ...
  try {
    ...
    // If user is admin and they're trying to access the root dashboard route, redirect to admin
    // We check the pathname by looking at the request, but since this is a layout, we'll handle it in the page component
  } catch (error) {
    console.error('[Dashboard Layout] Error checking admin:', error)
  }
